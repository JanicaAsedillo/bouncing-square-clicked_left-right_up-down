...
let positionY = 0;
let velocityX = 2;
let velocityY = 2; // Initial vertical velocity
let size = 50; // Initial size
let speedIncrement = 1; // Speed increment when clicked
let sizeDecrement = 5; // Size decrement when clicked
let isHorizontal = true; // Flag to indicate horizontal movement

let animationFrameId;

function update() {
    positionX += isHorizontal ? velocityX : 0;
    positionY += isHorizontal ? 0 : velocityY;
